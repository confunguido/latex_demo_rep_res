...
%DIF DEL manuscript_latex_demo-oldtmp-48856.tex   Fri Apr 19 16:40:29 2019
%DIF ADD manuscript_latex_demo.tex                Fri Apr 19 16:21:32 2019
...
We then calculated the Incremental Cost-Effectiveness Ratio (ICER) as in equation \ref{eq-ICER}. \DIFaddbegin \R{Rev1Com2} \DIFaddend As others have \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{shim2017,shim2017b,flasche2016}}%DIFAUXCMD
}\DIFaddend , we deemed the intervention cost-effective if the ICER was below 3 GDP per-Capita, and very cost-effective if the ICER fell below 1 GDP per-Capita. We assumed a baseline scenario of costs.
...
\R{Rev1Com3-1}\DIFadd{Estimates of seroprevalence in Puerto Rico indicate that prevalence in 9-year-olds is around 50\%. Coudeville et al. estimated 50\% of prevalence  in 9-year-olds \mbox{%DIFAUXCMD
\cite{Coudeville2016} }%DIFAUXCMD
in the clinical trial sites. According to Argüello, 49.8\% of participants between 10-18 years of age had a positive IgG anti-DENV antibodies \mbox{%DIFAUXCMD
\cite{arguello2015AJTMH}}%DIFAUXCMD
. Hence, we assume that the seroprevalence in 9-year-olds is around 50\% but estimate the sensitivity of our analysis from 25\% to 75\%}\R{Rev1Com3-2}\DIFadd{. 
}\DIFaddend 
